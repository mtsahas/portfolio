...
return (
  ...
  <body>
    <h1>resume</h1>
    <div class="resume">
    <h3> Click <a href="https://drive.google.com/file/d/1z_6UkB4gHfvOMoE4RmYI0dvGG2IZyDUa/view?usp=sharing" target="_blank">here</a> to see my full resume. </h3>
      <div class="category"> work experience </div>
        ...
        <div class ="title"> Researcher - Princeton-Intel REU <span class="date"> Summer 2022</span></div> 
          <div class = "description"> Last summer, I conducted research under Professor Malik and his graduate students 
      ...
      <div class="category"> extracurriculars </div>
        <div class ="title"> Activities Officer & House Officer - Quadrangle Club <span class="date"> February 2022-Present</span></div> 
            <div class = "description"> One of my major extracurriculars in college is being an officer in my eating club, Quad. As an activities officer, I 
            ...
            and communicating with the chefs and house manager about food, accomodations, and events. We also host events open to the entire undergraduate population,
